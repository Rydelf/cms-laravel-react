...
<div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body border-bottom">
                    <h4 class="card-title">Páginas Recientes</h4>
                </div>
                <div class="comment-widgets scrollable" style="height:430px;">
                            ...
                            <div class="comment-text w-100">
                                ...
                                <div class="comment-footer">
                                    ...
                                    <span class="label label-rounded {{ $page->status === 1 ? 'label-primary' : 'label-warning' }}">
                                        {{ $page->status === 1 ? 'Publicado' : 'Pendiente' }}
                                    </span>
                    ...
                    <div class="text-center border-top">
                        <a class="btn btn-rounded btn-primary mt-2 " href="{{ route('admin.pages.index') }}">Ver Más <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body border-bottom">
                <h4 class="card-title">Artículos de Blog Recientes</h4>
            </div>
            <div class="comment-widgets scrollable" style="height:430px;">
                        ...
                        <div class="comment-text w-100">
                            ...
                            <div class="comment-footer">
                                ...
                                <span class="label label-rounded {{ $blog->status === 1 ? 'label-primary' : 'label-warning' }}">
                                    {{ $blog->status === 1 ? 'Publicado' : 'Pendiente' }}
                                </span>
                                <span class="action-icons">
                ...
                @endforeach
                <div class="text-center border-top">
                    <a class="btn btn-rounded btn-primary mt-2 " href="{{ route('admin.blogs.index') }}">Ver Más <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
