<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label class="control-label" for="name">Nombre del Sitio <span class="required">*</span></label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label class="control-label" for="meta_author">Autor</label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <textarea class="form-control" rows="3" id="copyright_text" name="copyright_text"></textarea>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
