                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="first_name" name="first_name"
                                        value="{{ $admin->first_name }}" placeholder="Nombre" required="" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="last_name" name="last_name"
                                        value="{{ $admin->last_name }}" placeholder="Apellido" required="" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="designation" name="designation"
                                        value="{{ $admin->designation }}" placeholder="Cargo" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="phone_no" name="phone_no"
                                        value="{{ $admin->phone_no }}" placeholder="Teléfono" required="" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        value="{{ $admin->email }}" placeholder="Correo Electrónico" required="" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group has-success">
                                    ...
                                    <select class="form-control custom-select" id="status" name="status" required>
                                        <option value="1" {{ $admin->status == '1' ? 'selected' : null }}>Activo</option>
                                        <option value="0" {{ $admin->status == '0' ? 'selected' : null }}>Inactivo
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="password_confirmation"
                                        ...
                                        placeholder="Confirmar Contraseña" data-parsley-equalto="#password" autocomplete="off" />
                                </div>
                            </div>
                            @if (!Route::is('admin.admins.profile.edit'))
                                <div class="col-md-6">
...
@section('scripts')
    <script>
        $(".roles_select").select2({
            placeholder: "Seleccione los roles con acceso."
        });
    </script>
@endsection
