                        ...
                        <div class="row ">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="name">Nombre de Rol </label> <span class="border p-2">{{ $role->name }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <label class="control-label" for="allManagement">Permisos</label>
                            </div>
                            <div class="col-md-9">
                            ...
                            <div class="col-md-12">
                                <div class="form-actions">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('admin.roles.edit', $role->id) }}" class="btn btn-success"> <i class="fa fa-arrow-left"></i> Editar</a>
                                        @endif

                                        <a href="{{ route('admin.roles.index') }}" class="btn btn-dark">Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
