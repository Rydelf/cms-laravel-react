    ...
    <div class="auth-box">
        <div id="loginform">
            <div class="logo">
                ...
                <h5 class="font-medium m-b-20">Iniciar sesión como Admin</h5>
            </div>
            <!-- Form -->
            <div class="row">
                <div class="col-12">
                    ...
                    <form class="form-horizontal m-t-20" method="post" id="loginform" action="{{ route('admin.login.submit') }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg @error('username') is-invalid @enderror" name="username" placeholder="Username o Correo Electrónico" aria-label="Username" aria-describedby="basic-addon1">
                            @error('username')
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="password" class="form-control form-control-lg" name="password" placeholder="Contraseña" aria-label="Password" aria-describedby="basic-addon1">
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <a href="{{ route('admin.password.request') }}" class="text-dark float-right"><i class="fa fa-lock m-r-5"></i> ¿Olvidaste tu contraseña?</a>
                                </div>
                            </div>
                        </div>
