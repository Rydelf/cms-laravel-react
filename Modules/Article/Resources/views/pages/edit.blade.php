                ...
                <div class="form-body">
                    <div class="card-body">
                        <div class="row ">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="title">Título de Arículo <span class="required">*</span></label>
                                    <input type="text" class="form-control" id="title" name="title" value="{{ $page->title }}" placeholder="Título" required=""/>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="slug">Siglas <span class="optional">(opcional)</span></label>
                                    <input type="text" class="form-control" id="slug" name="slug" value="{{ $page->slug }}" placeholder="Ingrese siglas (Deje en blanco para completar automáticamente)" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group has-success">
                                    ...
                                    <select class="form-control custom-select" id="status" name="status" required>
                                        <option value="1" {{ $page->status === 1 ? 'selected' : null }}>Activo</option>
                                        <option value="0" {{ $page->status === 0 ? 'selected' : null }}>Inactivo</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="category_id">Categoría de Artículo <span class="optional">(opcional)</span></label>
                                    <br>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="article_type_id">Tipo de Artículo <span class="optional">(opcional)</span></label>
                                    <br>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="banner_image">Imagen <span class="optional">(opcional)</span></label>
                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label" for="description">Descripción <span class="optional">(optional)</span></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="meta_description" name="meta_description" placeholder="Descripción Interna">{!! $page->meta_description !!}</textarea>
                                </div>
