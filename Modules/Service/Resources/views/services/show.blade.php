                        ...
                        <div class="row ">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="title">Título de Página</label>
                                    <br>
                                    {{ $page->title }}
                                </div>
                            </div>
                                ...
                                <div class="form-actions">
                                    <div class="card-body">
                                        @if (Auth::user()->can('page.edit'))
                                            <a  class="btn btn-success" href="{{ route('admin.services.edit', $page->id) }}"> <i class="fa fa-edit"></i> Editar</a>
                                        @endif
                                        <a href="{{ route('admin.services.index') }}" class="btn btn-dark ml-2">Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
