                ...
                <div class="form-body">
                    <div class="card-body">
                        <div class="row ">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="title">Servicio <span class="required">*</span></label>
                                    <input type="text" class="form-control" id="title" name="title" value="{{ $service->title }}" placeholder="Servicio" required=""/>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="slug">Siglas <span class="optional">(opcional)</span></label>
                                    <input type="text" class="form-control" id="slug" name="slug" value="{{ $service->slug }}" placeholder="Ingrese siglas (Deje en blanco para completar automáticamente)" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group has-success">
                                    ...
                                    <select class="form-control custom-select" id="status" name="status" required>
                                        <option value="1" {{ $service->status === 1 ? 'selected' : null }}>Activo</option>
                                        <option value="0" {{ $service->status === 0 ? 'selected' : null }}>Inactivo</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="control-label" for="category_id">Categoría <span class="optional">(opcional)</span></label>
                                    <br>
                        ...
                        <div class="row ">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="image">Imagen Relacionada <span class="optional">(optional)</span></label>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="meta_description" name="meta_description" placeholder="Descripción Interna">{!! $service->meta_description !!}</textarea>
                                </div>
                                <div class="form-actions">
                                    <div class="card-body">
                                        <button type="submit" class="btn btn-success"> <i class="fa fa-check"></i> Guardar</button>
                                        <a href="{{ route('admin.services.index') }}" class="btn btn-dark">Cancelar</a>
                                    </div>
                                </div>
                            </div>
